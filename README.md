...
```bash
mkdir -p ~/.local/share/gnome-shell/extensions/claude-usage@mhtafhim.dev
cp -r claude-usage@mhtafhim.dev/* ~/.local/share/gnome-shell/extensions/claude-usage@mhtafhim.dev/
```
...
```bash
gnome-extensions enable claude-usage@mhtafhim.dev
```
